...
|2023.06 - Present|[SDK](https://docs.corca.dev/)|AI 상품 추천 SDK, 배너/상품 그리드/위젯 포맷의 추천 및 모뎅 위한 log collection 등 개발  (Vanilla JS)| [(주)코르카](https://www.corca.ai/ko/research) 서비스<br/>(프론트엔드 개발) |
